...
var mainRoute = {
            ...
            '/a01/p1': (_) => const MaterialPage(child: Page1(title:"P1")),
            '/a01/p2': (_) => const MaterialPage(child: Page2(title:"P2")),
            '/a01/p3': (_) => const MaterialPage(child: Page3(title:"P3")),
            '/a01/p4': (_) => const MaterialPage(child: Page4(title:"P4")),
